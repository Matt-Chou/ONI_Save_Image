  ...
  { 
    ...
    { 
            ...
            case PSYCHEDELIC: 
                    ...
                    break; 
            case RAINBOW: 
                    nColIndex = (XnUInt16)((*pDepth / (10000 / 256))); 
                    nRed = PalletIntsR[nColIndex]; 
                    nGreen = PalletIntsG[nColIndex]; 
                    nBlue = PalletIntsB[nColIndex]; 
                    break; 
   ...
   //CapturedFrames folder must exist!!! 
    std::string str_aux = "C:/Users/matt-pc/Documents/Visual Studio 2012/Projects/Save_Image/Save_Image/CapturedFrames/Depth/image_depth_"+ str_frame_number +".jpg"; 

   IplImage bgrIpl = depthImage;                      // create a IplImage header for the cv::Mat bgrImage 
   cvSaveImage(str_aux.c_str(),&bgrIpl);                // save it with the old 
