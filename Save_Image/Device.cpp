...
//     char c = 'a'; 
    ...
    std::string str_aux = "C:/Users/matt-pc/Documents/Visual Studio 2012/Projects/Save_Image/Save_Image/CapturedFrames/RGB/image_RGB_"+ str_frame_number +".jpg"; 
    IplImage bgrIpl = colorImage;                      // create a  IplImage header for the cv::Mat bgrImage 
